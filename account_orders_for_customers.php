        ...
        <div class='user_container_main'>
            ...
            ";
                ...
                <div class='user_block_bottom'>
                    ...
                    //                 <div class='input_orders_account'><form method='GET'><a href='./orders_chat.php?AccountOrders=" . $arr['ID'] . "' class='linkChat'>Перейти в чат</a></form></div>
                    //             </div>
                    //          </div>";
                    // }
